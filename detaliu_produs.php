                                ...
                                <div class="product-content">
                                    ...
                                    <form action="detaliu_produs.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post">
                                        ...
                                        <div class="add-to-cart">
                                            ...
                                            <p class="text-center buttons"><button name="add_cart" class="btn btn-primary i fa fa-shopping-cart"> Add to cart</button></p>
                                    </form>
                                     ...
                                     <div class="product-item">
                                        ...
                                        <div class="product-image">
                                                        ...
                                                        <div class="product-price">
                                                            ...
                                                            <a class="btn" href=""><i class="fa fa-shopping-cart"></i>Vezi detalii</a>
                                                        </div>
                                    </div>
                                </div>
                                ';
